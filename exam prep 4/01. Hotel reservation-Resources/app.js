...
function solve() {
    ...
    function onNextClick(event){
        ...
        if (inputs.firstName.value==''||inputs.lastName.value==''||inputs.dateIn.value==0||inputs.dateOut.value==''||inputs.peopleCount.value=='') {
            return
        }
        ...
        if (peopleCount<=0) {
            console.log('negative or zero peopleCount');
...
//vajno za shortcuti ctl+shift+arrow up/down/left/right selectirane po dumi